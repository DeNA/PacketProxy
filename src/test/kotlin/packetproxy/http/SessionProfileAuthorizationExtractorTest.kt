...
class SessionProfileAuthorizationExtractorTest {
  @Test
  fun extract_withAuthorizationHeader_returnsValue() {
    val request =
  ...
  @Test
  fun extract_withoutAuthorizationHeader_returnsEmptyString() {
    val request =
      ("GET /api/users HTTP/1.1\r\n" + "Host: example.com\r\n" + "Content-Length: 0\r\n" + "\r\n")
        .toByteArray()
