...
class QuicMessagesTest {
    ...
    @BeforeEach
    void before() {
        this.msgs = QuicMessages.of(
                QuicMessage.of(StreamId.of(1), new byte[]{ 0x1 }),
                QuicMessage.of(StreamId.of(2), new byte[]{ 0x2 }),
                QuicMessage.of(StreamId.of(3), new byte[]{ 0x3 })
        );
    }
    ...
    @Test
    void equalsが動作すること() {
        QuicMessages msgs2 = QuicMessages.of(
                QuicMessage.of(StreamId.of(1), new byte[]{ 0x1 }),
                QuicMessage.of(StreamId.of(2), new byte[]{ 0x2 }),
                QuicMessage.of(StreamId.of(3), new byte[]{ 0x3 })
        );
    ...
    void getBytesが動作すること() throws Exception {
        ...
        assertThat(bytes).isEqualTo(Hex.decodeHex("000000000000000100000000000000010100000000000000020000000000000001020000000000000003000000000000000103".toCharArray()));
    }
