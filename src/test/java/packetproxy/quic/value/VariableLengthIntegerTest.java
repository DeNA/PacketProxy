...
class VariableLengthIntegerTest {
    ...
    void parseEightBytes() throws Exception {
        // "the eight byte sequence c2 19 7c 5e ff 14 e8 8c decodes to 151288809941952652;"
    ...
    void parseExampleBytes() throws Exception {
        ...
        System.out.printf("%x\n", VariableLengthInteger.parse(Hex.decodeHex("f684f228323451e8".toCharArray())).getValue()); /* 3684f228323451e8 */
