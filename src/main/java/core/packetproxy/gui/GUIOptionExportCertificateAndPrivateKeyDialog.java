...
public class GUIOptionExportCertificateAndPrivateKeyDialog extends JDialog {
	...
	private JPanel createSelectPanel() {
		...
		JLabel certificateGuide = new JLabel(I18nString.get(
			...
			filechooser.addFileChooserListener(new WriteFileChooserWrapper.FileChooserListener() {
				...
				public void onApproved(File file, String extension) {
					try {
						...
						if (selectCertificatePEMButton.isSelected())
							ca.exportCertificatePEM(path);
						else if (selectCertificateDERButton.isSelected())
							ca.exportCertificateDER(path);
						else if (selectPrivateKeyPEMButton.isSelected())
							ca.exportPrivateKeyPEM(path);
						else if (selectPrivateKeyDERButton.isSelected())
							ca.exportPrivateKeyDER(path);
