...
public class GUIOptionImportCertificateAndPrivateKeyDialog extends JDialog {
    ...
    private JPanel createSelectPanel() {
        ...
        JLabel importCaution = new JLabel(I18nString.get("Importing overwrite PacketProxy per-user CA, so please export in advance if necessary"));
        panel.add(chooseImportType);
        panel.add(importCaution);

        JRadioButton selectPEMButton = new JRadioButton(I18nString.get("Certificate(PEM format)+Private Key(PEM format)"));
        JRadioButton selectDERButton = new JRadioButton(I18nString.get("Certificate(DER format)+Private Key(DER format)"));
        ...
        selectDoneButton.addActionListener(e -> {
            if (selectPEMButton.isSelected()) cardLayout.show(cardPanel, "import pem panel");
            else if (selectDERButton.isSelected()) cardLayout.show(cardPanel, "import der panel");
            else if (selectP12Button.isSelected()) cardLayout.show(cardPanel, "import p12 panel");
        });
    ...
    private JPanel createImportPEMPanel() {
        ...
        certificateChoosebutton.addActionListener(arg0 -> {
            try {
                certificatePEMChooser.addChoosableFileFilter(new FileNameExtensionFilter(I18nString.get("Certificate file (*.crt, *.pem)"), "crt", "pem"));
        ...
        privateKeyChoosebutton.addActionListener(arg0 -> {
            try {
                privateKeyPEMChooser.addChoosableFileFilter(new FileNameExtensionFilter(I18nString.get("Private Key file (*.key, *.pem)"), "key", "pem"));
        ...
        pemChooseDoneButton.addActionListener(arg0 -> {
            if (certificatePEMPathField.getText().equals("") || privateKeyPEMPathField.getText().equals("")) return;
            try {
    ...
    private JPanel createImportDERPanel() {
        ...
        certificateChoosebutton.addActionListener(arg0 -> {
            try {
                certificateDERChooser.addChoosableFileFilter(new FileNameExtensionFilter(I18nString.get("Certificate file (*.crt, *.der)"), "crt", "der"));
        ...
        privateKeyChoosebutton.addActionListener(arg0 -> {
            try {
                privateKeyDERChooser.addChoosableFileFilter(new FileNameExtensionFilter(I18nString.get("Private Key file (*.key, *.der)"), "key", "der"));
        ...
        derChooseDoneButton.addActionListener(arg0 -> {
            if (certificateDERPathField.getText().equals("") || privateKeyDERPathField.getText().equals("")) return;
            try {
    ...
    private JPanel createImportP12Panel() {
        ...
        p12Choosebutton.addActionListener(arg0 -> {
            try {
                p12Chooser.addChoosableFileFilter(new FileNameExtensionFilter(I18nString.get("P12 file (*.p12, *.pfx)"), "p12", "pfx"));
        ...
        p12ChooseDoneButton.addActionListener(arg0 -> {
            if (p12PathField.getText().equals("")) return;
            try {
