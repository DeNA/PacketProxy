...
public class OpenVPN {
	...
	public void patchContainer(DockerClient client, String localIp, String proto) {
		try {
			...
			/*
			 * restart the server. it is because - dockovpn is start in entrypoint, this
			 * means it is difficult to patch in CMD - so it seems to be necessary to patch
			 * in docker exec, but it is after docker start(now doing) - after patching, the
			 * server should be restarted to reflect the config
			 */
