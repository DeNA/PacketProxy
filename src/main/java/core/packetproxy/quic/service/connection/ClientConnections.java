...
public class ClientConnections {
    ...
    public ClientConnection accept() throws Exception {
        while (true) {
            ...
            if (find(destConnId).isPresent()) {
                ...
                Optional<ClientConnection> conn = this.create(destConnId, new InetSocketAddress(udpPacket.getAddress(), udpPacket.getPort()));
                if (conn.isPresent()) {
    ...
    public Optional<ClientConnection> create(ConnectionId initialSecret, InetSocketAddress peerAddr) throws Exception {
        ...
        ClientConnection conn = new ClientConnection(connIdPair, initialSecret, this.socket, peerAddr, this.ca, this.listenPort);
