...
public class TransportParameterParser {
    ...
    static public TransportParameter parse(ByteBuffer buffer) throws Exception {
    ...
    static private TransportParameter createInstance(Class<TransportParameter> klass, ByteBuffer buffer) throws Exception {
        return klass.getConstructor(ByteBuffer.class).newInstance(buffer);
    }

    static private TransportParameter createInstance(Class<TransportParameter> klass) throws Exception {
