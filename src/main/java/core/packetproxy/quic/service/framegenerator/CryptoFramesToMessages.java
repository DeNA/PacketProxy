...
public class CryptoFramesToMessages {
    ...
    static public HandshakeMessage convertToHandshakeMessage(byte[] handshakeMsgBytes) throws Exception {
        TlsMessageParser parser = new TlsMessageParser();
        DebugMessageProcessor processor = new DebugMessageProcessor();
        return parser.parseAndProcessHandshakeMessage(ByteBuffer.wrap(handshakeMsgBytes), processor, ProtectionKeysType.None);
    }
    ...
    public Optional<HandshakeMessage> getHandshakeMessage() {
        ...
        TlsMessageParser parser = new TlsMessageParser();
        DebugMessageProcessor processor = new DebugMessageProcessor();
        HandshakeMessage handshakeMessage = parser.parseAndProcessHandshakeMessage(ByteBuffer.wrap(message), processor, ProtectionKeysType.None);
    ...
    static private class DebugMessageProcessor implements MessageProcessor {
        @Override
        ...
        @Override
        public void received(EncryptedExtensions ee, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        }
        @Override
        public void received(CertificateMessage cm, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        }
        @Override
        public void received(CertificateVerifyMessage cv, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        }
        @Override
        public void received(FinishedMessage fm, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        }
        @Override
        public void received(NewSessionTicketMessage nst, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        }
        @Override
        public void received(CertificateRequestMessage cr, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        }
    }
