...
@AllArgsConstructor
public class Key {
    static final protected byte[] STATIC_SALT_V1 = new byte[]{
    ...
    static public byte[] hkdfExpandLabel(byte[] secret, String labelStr, String contextStr, short length) {
    ...
    static public Key of(byte[] secret) {
    ...
    public String toString() {
        return String.format("Key(secret=%s, key=%s, iv=%s, hp=%s)",
                Hex.encodeHexString(this.secret),
                Hex.encodeHexString(this.key),
                Hex.encodeHexString(this.iv),
                Hex.encodeHexString(this.hp));
    }
