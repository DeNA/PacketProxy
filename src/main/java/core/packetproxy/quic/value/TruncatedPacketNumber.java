...
public class TruncatedPacketNumber {
	...
	private static byte[] encode(PacketNumber packetNumber, PacketNumber largestAckPn) {
		/*
		 * The number of bits must be at least one more than the base-2 logarithm of the
		 * number of contiguous unacknowledged packet numbers, including the new packet.
		 */
