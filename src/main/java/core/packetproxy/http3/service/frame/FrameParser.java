...
public class FrameParser {
	...
	public static Frames parse(byte[] bytes) throws Exception {
		return parse(ByteBuffer.wrap(bytes));
	}

	public static Frames parse(ByteBuffer buffer) throws Exception {
	...
	private static long getTypeWithoutIncrement(ByteBuffer buffer) {
