...
public class SettingsFrame implements Frame {
    ...
    static public final long TYPE = 0x04;

    static public List<Long> supportedTypes() {
        return ImmutableList.of(TYPE);
    }

    static public SettingsFrame generateSettingsFrameWithDefaultValue() {
        return new SettingsFrame(Setting.generateWithDefaultValue());
    }

    static public SettingsFrame of(Setting setting) {
        return new SettingsFrame(setting);
    }

    static public SettingsFrame parse(ByteBuffer buffer) throws Exception {
