...
public class JsonSyntaxHighlighter {
	...
	private void applyJsonSyntaxHighlightingToHttpBody(String fullText, HttpBodyInfo bodyInfo) throws BadLocationException {
	...
	private void highlightWithJsonParserAtOffset(StyledDocument doc, String text, int offset) throws BadLocationException {
