...
public class ClientConnection extends Connection implements Endpoint {
	...
	public ClientConnection(ConnectionIdPair connIdPair, ConnectionId initialSecret, DatagramSocket socket,
			InetSocketAddress peerAddr, CA ca, int listenPortNum) throws Exception {
